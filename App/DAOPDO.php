...
class DAOPDO
{
    ...
    private function __construct($dbHost, $dbUser, $dbPasswd, $dbName, $dbCharset)
    {
        try {
            ...
            $opts = array( PDO::ATTR_TIMEOUT => 3);
            //$this->dbh = new PDO($this->dsn, $dbUser, $dbPasswd);
            $this->dbh = new PDO($this->dsn, $dbUser, $dbPasswd,array(PDO::ATTR_PERSISTENT => true));
            //$this->dbh = new PDO($this->dsn, $dbUser, $dbPasswd,$opts);
    ...
    public function insert($table, $arrayDataValue, $debug = false)
    {
        ...
        $result = $this->dbh->exec($strSql);
        $this->getPDOError();
        $res = $this->dbh->lastInsertId() ? : $result;
        return $res;
    }
